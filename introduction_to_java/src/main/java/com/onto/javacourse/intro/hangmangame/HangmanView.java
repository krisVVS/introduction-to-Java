...
/**
 * The HangmanView class handles the user interface for the Hangman game.
 * It displays the game status, prompts the user for input, and shows game over messages.
 */
public class HangmanView {
     ...
     *
     * @param currentGuess    the current state of the guessed word with guessed letters revealed and remaining letters as underscores
     ...
     */
    public void displayGameStatus(String currentGuess, int remainingGuesses, Set<Character> guessedLetters) {
