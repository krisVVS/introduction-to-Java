 ...
 * The algorithm involves reversing them and adding extra 0s until both numbers are the same length.
 * After that, we add every two one-digit numbers together + a carry value, which differs between 1 and 0
 * depending on whether the sum of the two is greater than or equal to 10.
 */
