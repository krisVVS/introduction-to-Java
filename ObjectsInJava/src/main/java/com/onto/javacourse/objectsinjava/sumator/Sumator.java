...
/**
 * The {@code Sumator} class provides methods to sum various types of numbers.
 * It supports summing integers, floating-point numbers, strings that represent numbers,
 * and objects of types {@link BigInteger} and {@link BigDecimal}.
 */
public class Sumator {
    ...
    /**
     * Sums two strings that represent numbers.
     * The strings are parsed as doubles before summing.
     *
