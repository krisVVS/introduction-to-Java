...
/**
 * The {@code DrawerRectangle} class implements the {@code Drawer} interface for drawing {@code
 * Rectangle} objects using an {@code OntoRobot}.
 *
 * <p>This class contains the logic to draw a rectangle on a grid by placing beepers at the corners
 * and along the edges according to the specified width and height.
 */
public class DrawerRectangle implements Drawer<Rectangle> {

  /**
   * Draws a rectangle using the specified {@code Rectangle} object and {@code OntoRobot}. The robot
   * moves to the starting point of the rectangle and places beepers along its edges based on the
   * rectangle's dimensions.
   *
   * @param rectangle the {@code Rectangle} object that defines the dimensions and position of the
   *     rectangle to draw
