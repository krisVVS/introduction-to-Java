...
/**
 * The {@code DrawerPoint} class implements the {@code Drawer} interface
 * for drawing {@code Point} objects using an {@code OntoRobot}.
 * <p>
 * This class contains the logic to place a beeper at a specified point
 * in the grid, represented by its coordinates.
 * </p>
 */
public class DrawerPoint implements Drawer<Point> {

    /**
     * Draws a point using the specified {@code Point} object and {@code OntoRobot}.
     * The robot moves to the coordinates of the point and places a beeper there.
     *
